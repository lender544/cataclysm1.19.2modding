...
public class LayerDeeplingBruteItem extends RenderLayer<Deepling_Brute_Entity, ModelDeepling_Brute> {
    private final ItemInHandRenderer itemInHandRenderer;

    public LayerDeeplingBruteItem(RenderLayerParent p_234846_, ItemInHandRenderer p_234847_) {
        super(p_234846_);
        this.itemInHandRenderer = p_234847_;
    }

    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Deepling_Brute_Entity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
