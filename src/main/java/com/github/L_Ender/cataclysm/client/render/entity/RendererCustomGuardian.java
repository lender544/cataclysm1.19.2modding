...
import com.github.L_Ender.cataclysm.client.model.entity.ModelCustomGuardian;
...
@OnlyIn(Dist.CLIENT)
public class RendererCustomGuardian extends MobRenderer<CustomGuardian, ModelCustomGuardian> {
    ...
    public RendererCustomGuardian(EntityRendererProvider.Context p_174159_) {
        this(p_174159_, 0.5F, ModelLayers.GUARDIAN);
    }

    protected RendererCustomGuardian(EntityRendererProvider.Context p_174161_, float p_174162_, ModelLayerLocation p_174163_) {
        super(p_174161_, new ModelCustomGuardian(p_174161_.bakeLayer(p_174163_)), p_174162_);
    }

    public boolean shouldRender(CustomGuardian p_114836_, Frustum p_114837_, double p_114838_, double p_114839_, double p_114840_) {
    ...
    public void render(CustomGuardian p_114829_, float p_114830_, float p_114831_, PoseStack p_114832_, MultiBufferSource p_114833_, int p_114834_) {
    ...
    public ResourceLocation getTextureLocation(CustomGuardian p_114827_) {
