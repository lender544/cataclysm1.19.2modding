...
import com.github.L_Ender.cataclysm.client.model.entity.ModelBaby_Leviathan;
...
@OnlyIn(Dist.CLIENT)
public class RendererThe_Baby_Leviathan extends MobRenderer<The_Baby_Leviathan_Entity, ModelBaby_Leviathan> {
    ...
    public RendererThe_Baby_Leviathan(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new ModelBaby_Leviathan(), 0.25F);
    }
    @Override
