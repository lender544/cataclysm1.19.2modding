...
@OnlyIn(Dist.CLIENT)
public class Deepling_Brute_Layer extends RenderLayer<Deepling_Brute_Entity, ModelDeepling_Brute> {
    ...
    public Deepling_Brute_Layer(RendererDeepling_Brute renderIn) {
		super(renderIn);
	...
	@Override
	public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Deepling_Brute_Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
	{
