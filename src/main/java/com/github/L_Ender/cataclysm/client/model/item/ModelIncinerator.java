...
public class ModelIncinerator extends AdvancedEntityModel<Entity> {
    ...
    public ModelIncinerator() {
        ...
        blade_mid.setPos(0.0F, -25.8F, 0.0F);
        ...
        handle_core.setPos(0.0F, -4.5F, 0.0F);
        ...
        lower_guard.setPos(0.0F, -25.5F, -1.9F);
