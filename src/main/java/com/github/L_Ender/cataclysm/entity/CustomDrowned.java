...
public class CustomDrowned extends Zombie implements RangedAttackMob {
    boolean searchingForLand;
    protected final WaterBoundPathNavigation waterNavigation;
    protected final GroundPathNavigation groundNavigation;

    public CustomDrowned(EntityType<? extends CustomDrowned> p_32344_, Level p_32345_) {
        super(p_32344_, p_32345_);
        this.maxUpStep = 1.0F;
        this.moveControl = new CustomDrowned.DrownedMoveControl(this);
    ...
    protected void addBehaviourGoals() {
        this.goalSelector.addGoal(1, new CustomDrowned.DrownedGoToWaterGoal(this, 1.0D));
        this.goalSelector.addGoal(2, new CustomDrowned.DrownedTridentAttackGoal(this, 1.0D, 40, 10.0F));
        this.goalSelector.addGoal(2, new CustomDrowned.DrownedAttackGoal(this, 1.0D, false));
        this.goalSelector.addGoal(5, new CustomDrowned.DrownedGoToBeachGoal(this, 1.0D));
        this.goalSelector.addGoal(6, new CustomDrowned.DrownedSwimUpGoal(this, 1.0D, this.level.getSeaLevel()));
        this.goalSelector.addGoal(7, new RandomStrollGoal(this, 1.0D));
        this.targetSelector.addGoal(1, (new HurtByTargetGoal(this, CustomDrowned.class)).setAlertOthers(ZombifiedPiglin.class));
    ...
    public static boolean checkDrownedSpawnRules(EntityType<CustomDrowned> p_218956_, ServerLevelAccessor p_218957_, MobSpawnType p_218958_, BlockPos p_218959_, RandomSource p_218960_) {
    ...
    static class DrownedAttackGoal extends ZombieAttackGoal {
        private final CustomDrowned drowned;

        public DrownedAttackGoal(CustomDrowned p_32402_, double p_32403_, boolean p_32404_) {
    ...
    static class DrownedGoToBeachGoal extends MoveToBlockGoal {
        ...
        public DrownedGoToBeachGoal(CustomDrowned p_32409_, double p_32410_) {
    ...
    static class DrownedMoveControl extends MoveControl {
        ...
        public DrownedMoveControl(CustomDrowned p_32433_) {
            super(p_32433_);
    ...
    static class DrownedSwimUpGoal extends Goal {
        ...
        public DrownedSwimUpGoal(CustomDrowned p_32440_, double p_32441_, int p_32442_) {
    ...
    static class DrownedTridentAttackGoal extends RangedAttackGoal {
        ...
        public DrownedTridentAttackGoal(RangedAttackMob p_32450_, double p_32451_, int p_32452_, float p_32453_) {
            ...
            this.drowned = (CustomDrowned)p_32450_;
        }
