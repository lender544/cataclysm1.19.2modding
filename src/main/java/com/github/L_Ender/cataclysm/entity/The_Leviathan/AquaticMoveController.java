...
public class AquaticMoveController extends MoveControl {
    ...
    public AquaticMoveController(PathfinderMob entity, float speedMulti, float ySpeedMod) {
        super(entity);
        this.entity = entity;
    ...
    public AquaticMoveController(PathfinderMob entity, float speedMulti, float ySpeedMod, float yawLimit) {
        super(entity);
        this.entity = entity;
        this.speedMulti = speedMulti;
        this.ySpeedMod = ySpeedMod;
