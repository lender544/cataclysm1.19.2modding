...
public class CustomGuardian extends Monster {
    protected static final int ATTACK_TIME = 80;
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(CustomGuardian.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_ID_ATTACK_TARGET = SynchedEntityData.defineId(CustomGuardian.class, EntityDataSerializers.INT);
    ...
    public CustomGuardian(EntityType<? extends CustomGuardian> p_32810_, Level p_32811_) {
        super(p_32810_, p_32811_);
        this.xpReward = 10;
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.moveControl = new CustomGuardian.GuardianMoveControl(this);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new CustomGuardian.GuardianAttackGoal(this));
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, false, new CustomGuardian.GuardianAttackSelector(this)));
    }
    ...
    static class GuardianAttackGoal extends Goal {
        ...
        public GuardianAttackGoal(CustomGuardian p_32871_) {
    ...
    static class GuardianAttackSelector implements Predicate<LivingEntity> {
        ...
        public GuardianAttackSelector(CustomGuardian p_32879_) {
    ...
    static class GuardianMoveControl extends MoveControl {
        ...
        public GuardianMoveControl(CustomGuardian p_32886_) {
            super(p_32886_);
