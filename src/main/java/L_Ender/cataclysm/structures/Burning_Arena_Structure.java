...
public class Burning_Arena_Structure extends Structure {
    ...
    public static void start(StructureTemplateManager templateManager, BlockPos pos, Rotation rotation, StructurePieceAccessor pieceList, RandomSource random) {
        ...
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA1, blockpos, rotation));

        rotationOffSet = new BlockPos(0, 0, 38).rotate(rotation);
        blockpos = rotationOffSet.offset(x, pos.getY(), z);
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA2, blockpos, rotation));

        rotationOffSet = new BlockPos(47, 0, 0).rotate(rotation);
        blockpos = rotationOffSet.offset(x, pos.getY(), z);
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA3, blockpos, rotation));

        rotationOffSet = new BlockPos(47, 0, 38).rotate(rotation);
        blockpos = rotationOffSet.offset(x, pos.getY(), z);
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA4, blockpos, rotation));

        rotationOffSet = new BlockPos(0, 48, 0).rotate(rotation);
        blockpos = rotationOffSet.offset(x, pos.getY(), z);
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA5, blockpos, rotation));

        rotationOffSet = new BlockPos(0, 48, 38).rotate(rotation);
        blockpos = rotationOffSet.offset(x, pos.getY(), z);
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA6, blockpos, rotation));

        rotationOffSet = new BlockPos(47, 48, 0).rotate(rotation);
        blockpos = rotationOffSet.offset(x, pos.getY(), z);
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA7, blockpos, rotation));

        rotationOffSet = new BlockPos(47, 48, 38).rotate(rotation);
        blockpos = rotationOffSet.offset(x, pos.getY(), z);
        pieceList.addPiece(new Burning_Arena_Structure.Piece(templateManager, ARENA8, blockpos, rotation));
    }
