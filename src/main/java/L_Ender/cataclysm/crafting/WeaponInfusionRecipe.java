...
public class WeaponInfusionRecipe implements Recipe<Container> {
    final Ingredient base;
    final Ingredient addition;
    final ItemStack result;
    private final ResourceLocation id;

    public WeaponInfusionRecipe(ResourceLocation p_44523_, Ingredient p_44524_, Ingredient p_44525_, ItemStack p_44526_) {
        this.id = p_44523_;
        this.base = p_44524_;
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipeSerializers.WEAPON_INFUSION.get();
    }

    public RecipeType<?> getType() {
        return ModRecipeTypes.WEAPON_INFUSION.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<WeaponInfusionRecipe> {
        public WeaponInfusionRecipe fromJson(ResourceLocation p_44562_, JsonObject p_44563_) {
            ...
            return new WeaponInfusionRecipe(p_44562_, ingredient, ingredient1, itemstack);
        }

        public WeaponInfusionRecipe fromNetwork(ResourceLocation p_44565_, FriendlyByteBuf p_44566_) {
        ...
        public void toNetwork(FriendlyByteBuf p_44553_, WeaponInfusionRecipe p_44554_) {
