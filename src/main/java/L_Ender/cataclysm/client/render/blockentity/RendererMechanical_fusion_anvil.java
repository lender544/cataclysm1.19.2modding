...
import L_Ender.cataclysm.blocks.Mechanical_fusion_Anvil;
import L_Ender.cataclysm.client.model.block.Model_Mechanical_Anvil;

import L_Ender.cataclysm.tileentities.TileEntityMechanical_fusion_Anvil;
...
public class RendererMechanical_fusion_anvil<T extends TileEntityMechanical_fusion_Anvil> implements BlockEntityRenderer<T> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("cataclysm:textures/blocks/mechanical_fusion_anvil.png");
