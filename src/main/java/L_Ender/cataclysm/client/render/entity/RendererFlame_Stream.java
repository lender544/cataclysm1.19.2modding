...
import L_Ender.cataclysm.entity.projectile.Flame_Stream_Entity;
...
@OnlyIn(Dist.CLIENT)
public class RendererFlame_Stream extends EntityRenderer<Flame_Stream_Entity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("cataclysm:textures/entity/ignis/flame_stream.png");
    ...
    public RendererFlame_Stream(EntityRendererProvider.Context mgr) {
        super(mgr);
    }

    @Override
    public ResourceLocation getTextureLocation(Flame_Stream_Entity entity) {
        return TEXTURE;
    }

    @Override
    public void render(Flame_Stream_Entity solarBeam, float entityYaw, float delta, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
