...
import static L_Ender.cataclysm.entity.Ignis_Entity.*;
...
public class ModelIgnis extends AdvancedEntityModel<Ignis_Entity> {
    ...
    public ModelIgnis() {
        ...
        upperbody.setPos(0.0F, -24.5F, 1.0F);
        ...
        right_chestplate.setPos(-6.8F, -6.5F, -4.5F);
        ...
        left_chestplate.setPos(6.8F, -6.5F, -4.5F);
        ...
        right_plate.setPos(-5.3F, -12.9F, 8.0F);
        ...
        left_plate.setPos(5.3F, -12.9F, 8.0F);
        ...
        right_helmet.setPos(-4.5F, -3.0F, -4.5F);
        ...
        left_helmet.setPos(4.5F, -3.0F, -4.5F);
        ...
        head_plate.setPos(0.0F, -7.0F, -4.0F);
        ...
        right_horn.setPos(-3.5F, -7.5F, -3.5F);
        ...
        right_horn2.setPos(0.0F, -5.0F, -1.0F);
        ...
        right_horn3.setPos(0.0F, -6.99F, 1.99F);
        ...
        left_horn.setPos(3.5F, -7.5F, -3.5F);
        ...
        left_horn2.setPos(0.0F, -5.0F, -1.0F);
        ...
        left_horn3.setPos(0.0F, -6.99F, 1.99F);
        ...
        left_arm_joint.setPos(15.8F, -14.0F, 3.0F);
        ...
        left_fasteners3.setPos(4.5F, 6.0F, -7.0F);
        ...
        left_spike.setPos(11.9F, 2.4F, 0.0F);
        ...
        left_big_spike.setPos(9.5F, -2.8F, 0.0F);
        ...
        left_hand.setPos(8.2F, 18.4F, 0.0F);
        ...
        left_fasteners.setPos(1.1966F, 11.2224F, -6.0F);
        ...
        left_big_guantlet.setPos(2.0F, 12.0F, 0.0F);
        ...
        shield_root.setPos(2.0F, -6.0F, 0.0F);
        ...
        left_guantlet.setPos(-1.0F, 3.0F, 0.0F);
        ...
        left_fist.setPos(-1.5F, 8.0F, 0.0F);
        ...
        right_arm_joint.setPos(-15.8F, -14.0F, 3.0F);
        ...
        right_fasteners.setPos(-4.5F, 6.0F, -7.0F);
        ...
        right_spike.setPos(-11.9F, 2.4F, 0.0F);
        ...
        right_big_spike.setPos(-9.5F, -2.8F, 0.0F);
        ...
        right_hand.setPos(-8.2F, 18.4F, 0.0F);
        ...
        right_fasteners2.setPos(-1.1966F, 11.2224F, -6.0F);
        ...
        right_big_guantlet.setPos(-2.0F, 12.0F, 0.0F);
        ...
        right_guantlet.setPos(1.0F, 3.0F, 0.0F);
        ...
        right_fist.setPos(1.5F, 8.0F, 0.0F);
        ...
        blade_mid.setPos(0.0F, 0.0F, -8.8F);
        ...
        handle_core.setPos(0.0F, 0.0F, 12.5F);
        ...
        upper_guard.setPos(0.0F, -1.9F, -8.5F);
        ...
        lower_guard.setPos(0.0F, 1.9F, -8.5F);
        ...
        bodycore.setPos(0.0F, 0.0F, 0.0F);
        ...
        lowerbody.setPos(0.0F, -27.0F, 1.0F);
        ...
        right_thighplate.setPos(-5.7F, 10.3F, -1.0F);
        ...
        left_thighplate.setPos(5.7F, 10.3F, -1.0F);
        ...
        lowerbody2.setPos(0.0F, 5.0F, -5.0F);
    ...
    public void animate(Ignis_Entity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.setAnimation(Ignis_Entity.FOUR_COMBO);
        animator.startKeyframe(12);
        animator.rotate(root, 0, (float) Math.toRadians(-25F), 0);
...
//4
        ...
        animator.startKeyframe(12);
        animator.rotate(root, 0, (float) Math.toRadians(-25F), 0);
        animator.rotate(upperbody, (float) Math.toRadians(75F), (float) Math.toRadians(55F), (float) Math.toRadians(90F));
        animator.rotate(head, (float) Math.toRadians(-7.5F), (float) Math.toRadians(-30F), (float) Math.toRadians(-2.5F));
        animator.rotate(right_arm_joint, (float) Math.toRadians(-52.5F), (float) Math.toRadians(-40F), (float) Math.toRadians(-2.5F));
        animator.rotate(right_hand, (float) Math.toRadians(62.5F), (float) Math.toRadians(52.5F), (float) Math.toRadians(-17.5F));
        animator.rotate(right_fist, (float) Math.toRadians(-17.5F), (float) Math.toRadians(27.5F), (float) Math.toRadians(-32.5F));
        animator.rotate(left_arm_joint, (float) Math.toRadians(-87.5F), (float) Math.toRadians(87.5F), (float) Math.toRadians(-7.5F));
        animator.rotate(left_hand, (float) Math.toRadians(95F), (float) Math.toRadians(100F), (float) Math.toRadians(65F));
        animator.endKeyframe();
        ...
        animator.rotate(upperbody, (float) Math.toRadians(-17.5F), (float) Math.toRadians(-37.5F), 0);
        animator.rotate(head, (float) Math.toRadians(-12.5F), (float) Math.toRadians(62.5F), (float) Math.toRadians(-12.5F));
        animator.rotate(right_arm_joint, (float) Math.toRadians(-107.5F), (float) Math.toRadians(-45F), (float) Math.toRadians(7.5F));
        animator.rotate(right_hand, (float) Math.toRadians(-20F), (float) Math.toRadians(52.5F), (float) Math.toRadians(-70F));
        animator.rotate(right_fist, (float) Math.toRadians(-15F), 0, (float) Math.toRadians(-32.5F));
        animator.move(left_arm_joint, -3, 0, 4);
        animator.rotate(left_arm_joint, (float) Math.toRadians(-90F), (float) Math.toRadians(52.5F), (float) Math.toRadians(-67.5F));
        animator.rotate(left_hand, (float) Math.toRadians(20F), (float) Math.toRadians(7.5F), 0);
        animator.endKeyframe();
        ...
        animator.rotate(head, (float) Math.toRadians(-15F), (float) Math.toRadians(30F), (float) Math.toRadians(-12.5F));
        animator.rotate(right_arm_joint, (float) Math.toRadians(-147.5F), (float) Math.toRadians(-25F), (float) Math.toRadians(35F));
        animator.rotate(right_hand, (float) Math.toRadians(40F), (float) Math.toRadians(-5F), (float) Math.toRadians(-5F));
        animator.rotate(right_fist, (float) Math.toRadians(-25F), 0, (float) Math.toRadians(22.5F));
        animator.rotate(sword, (float) Math.toRadians(5F), (float) Math.toRadians(182.5F), (float) Math.toRadians(-57.5F));
        ...
        animator.rotate(left_fist, 0, (float) Math.toRadians(10F), (float) Math.toRadians(2F));
        animator.endKeyframe();
        ...
        animator.setAnimation(VERTICAL_COMBO);
        if(!entity.getIsShieldBreak()) {
            animator.startKeyframe(8);
            animator.rotate(root, 0, (float) Math.toRadians(30F), 0);
            animator.rotate(upperbody, (float) Math.toRadians(-5F), 0, (float) Math.toRadians(5F));
            animator.rotate(right_arm_joint, (float) Math.toRadians(-125F), (float) Math.toRadians(20F), 0);
            animator.rotate(right_hand, (float) Math.toRadians(-15F), (float) Math.toRadians(12.5F), (float) Math.toRadians(-55F));
            animator.rotate(right_fist, (float) Math.toRadians(-50F), 0, 0);
            animator.rotate(head, (float) Math.toRadians(-2.5F), (float) Math.toRadians(-15F), (float) Math.toRadians(7.5F));
            animator.rotate(left_arm_joint, (float) Math.toRadians(22.5F), (float) Math.toRadians(-35F), (float) Math.toRadians(7.5F));
            animator.rotate(left_hand, (float) Math.toRadians(-20F), (float) Math.toRadians(-10F), (float) Math.toRadians(-15F));
            animator.endKeyframe();
            ...
            animator.startKeyframe(2);
            animator.rotate(root, 0, (float) Math.toRadians(-62.5F), 0);
            animator.rotate(upperbody, (float) Math.toRadians(-2.5F), (float) Math.toRadians(-25F), (float) Math.toRadians(-17.5F));
            animator.rotate(right_arm_joint, (float) Math.toRadians(-35F), (float) Math.toRadians(-10F), (float) Math.toRadians(12.5F));
            animator.rotate(right_hand, (float) Math.toRadians(-47.5F), (float) Math.toRadians(80F), (float) Math.toRadians(-47.5F));
            animator.rotate(right_fist, (float) Math.toRadians(25F), 0, 0);
            animator.rotate(head, (float) Math.toRadians(7.5F), (float) Math.toRadians(67.5F), (float) Math.toRadians(-7.5F));
            animator.rotate(left_arm_joint, (float) Math.toRadians(17.5F), (float) Math.toRadians(-45F), (float) Math.toRadians(7.5F));
            animator.rotate(left_hand, (float) Math.toRadians(-20F), (float) Math.toRadians(-10F), (float) Math.toRadians(-15F));
            animator.endKeyframe();
            ...
            animator.rotate(root, (float) Math.toRadians(-7.5F), (float) Math.toRadians(-225F), (float) Math.toRadians(5F));
            animator.rotate(upperbody, (float) Math.toRadians(-40F), (float) Math.toRadians(-15F), (float) Math.toRadians(2.5F));
            animator.rotate(right_arm_joint, (float) Math.toRadians(-115F), (float) Math.toRadians(100F), (float) Math.toRadians(-20F));
            animator.rotate(right_hand, (float) Math.toRadians(5F), (float) Math.toRadians(55F), (float) Math.toRadians(27.5F));
            animator.rotate(right_fist, (float) Math.toRadians(65F), (float) Math.toRadians(-2.5F), (float) Math.toRadians(-17.5F));
            animator.rotate(head, (float) Math.toRadians(7.5F), (float) Math.toRadians(-32.5F), (float) Math.toRadians(-2.5F));
            animator.rotate(left_arm_joint, (float) Math.toRadians(10F), (float) Math.toRadians(-40F), (float) Math.toRadians(7.5F));
            animator.rotate(left_hand, (float) Math.toRadians(-25F), (float) Math.toRadians(-10F), (float) Math.toRadians(-15F));
            animator.endKeyframe();


            animator.startKeyframe(5);
            animator.rotate(root, (float) Math.toRadians(5F), (float) Math.toRadians(-445F), 0);
            animator.rotate(upperbody, (float) Math.toRadians(-7.5F), (float) Math.toRadians(-7.5F), (float) Math.toRadians(-7.5F));
            animator.rotate(right_arm_joint, (float) Math.toRadians(-57.5F), (float) Math.toRadians(-15F), (float) Math.toRadians(27.5F));
            animator.rotate(right_hand, (float) Math.toRadians(35F), (float) Math.toRadians(75F), (float) Math.toRadians(27.5F));
            animator.rotate(right_fist, (float) Math.toRadians(65F), (float) Math.toRadians(-2.5F), (float) Math.toRadians(-17.5F));
            animator.rotate(head, (float) Math.toRadians(-5F), (float) Math.toRadians(62.5F), (float) Math.toRadians(2.5F));
            animator.rotate(left_arm_joint, (float) Math.toRadians(55F), (float) Math.toRadians(-67.5F), (float) Math.toRadians(-25F));
            animator.rotate(left_hand, (float) Math.toRadians(-40F), (float) Math.toRadians(-10F), (float) Math.toRadians(-15F));
            animator.endKeyframe();
            animator.setStaticKeyframe(10);

            animator.startKeyframe(0);
            animator.rotate(root, (float) Math.toRadians(5F), (float) Math.toRadians(-85F), 0);
            animator.rotate(upperbody, (float) Math.toRadians(-7.5F), (float) Math.toRadians(-7.5F), (float) Math.toRadians(-7.5F));
            animator.rotate(right_arm_joint, (float) Math.toRadians(-57.5F), (float) Math.toRadians(-15F), (float) Math.toRadians(27.5F));
            animator.rotate(right_hand, (float) Math.toRadians(35F), (float) Math.toRadians(75F), (float) Math.toRadians(27.5F));
            animator.rotate(right_fist, (float) Math.toRadians(65F), (float) Math.toRadians(-2.5F), (float) Math.toRadians(-17.5F));
